...
var PALETTE_ENTRIES = (() => {
    ...
    const GITLAB_GROUPS = [
        ...
        { group: 'cynergybank/fusion-reboot-poc/backend', repos: ['accounting-connection-api', 'accounts-api', 'activity-tracker-api', 'affiliation-api', 'ai-insights-api', 'aime-console', 'api-qa-stack-pipeline', 'application-referral-api', 'applications-api', 'approvals-api', 'attestation-dashboard', 'auth-api', 'auth-consumer', 'boardroom-minutes-api', 'boardroom-minutes-frontend', 'card-management-proxy', 'cards-cheques-api', 'case-file-api', 'cash-balances-poc', 'cashflow-api', 'chainlit-poc', 'ci-templates', 'cifas-adapter-api', 'common-library', 'companies-house-connector', 'compliance-check-project', 'compliance-scanning-ai', 'contentful-exporter', 'contract-api', 'contracts', 'credit-memo-contracts', 'credit-memo-cqc-importer', 'credit-memo-cqc-scotland-importer', 'credit-memo-customer-case-api', 'credit-memo-epc-scotland-importer', 'credit-memo-helpers-api', 'credit-memo-integrations-api', 'currency-service', 'customer-account-query-api', 'customer-api', 'customer-authentication-gateway', 'customer-communications-gateway', 'customer-consumer', 'customer-devices-api', 'customer-feedback-importer', 'customer-onboarding-api', 'customer-onboarding-consumer', 'customer-orchestration-api', 'customer-preferences-api', 'customer-workflows-api', 'customer-workflows-consumer', 'dashboards-api', 'dast-scanner', 'digital-channels-console', 'digital-exp-metrics-dashboard', 'document-api', 'document-orchestration-api', 'equifax-connector', 'faq-assistant-api', 'faq-assistant-console', 'faq-sop-assistant-api', 'feature-flags-api', 'file-mapper', 'file-scan-api', 'fraud-review-service', 'gatekeeper-api', 'google-adapter', 'google-adapter-consumer', 'hcl-api', 'hcl-consumer', 'helper-service', 'hr-chatbot-api', 'insight-agent-delete', 'jira-tracking', 'jumio-connector', 'locations-api', 'maturities-api', 'microsoft-graph-adapter', 'mocksms-api', 'mq-services', 'neteller-service', 'notification-consumer', 'notification-legacy-consumer', 'notification-preferences-api', 'notification-preferences-legacy-api', 'notification-receiver-api', 'notification-sender-api', 'notification-service', 'ntb-applications-api', 'ntb-dashboard', 'open-banking-accounts-api', 'open-banking-api', 'open-banking-consents-api', 'originations-api', 'p1-p2-roto', 'payee-api', 'payments-api', 'payments-management-api', 'product-eligibilities-api', 'products-api', 'promon-dashboard', 'promon-insight-agent', 'python-backend-service-template', 'relationship-api', 'relationship-manager-api', 'relationship-manager-consumer', 'release-note-generator', 'review-sentiment-classifier', 'salesforce-ncino-bridge', 'salesforce-pubsub-api', 'scheduler-service', 'secure-messages-api', 'secure-messages-consumer', 'statements-api', 'strata', 'testing-api', 'timesheet-new', 'tools', 'ui-audit-api', 'user-journeys-api', 'web-vtt-helper-api', 'webchat-api', 'whats-new-api'] },
        ...
        { group: 'cynergybank/ai/agentic-platform', repos: ['agents', 'commands', 'devkit', 'installer', 'practices', 'skills'] },
    ];
